Shader "CTS Terrain Shader Advanced LOD"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 lerpResult3776 = lerp( float3( 0,0,1 ) , appendResult10_g668 , clampResult3775);
			float3 lerpResult3906 = lerp( float3( 0,0,1 ) , appendResult10_g668 , ( _Snow_Perlin_Power * 0.5 ));
			...
			float3 normalizeResult3901 = normalize( UnpackScaleNormal( tex2D( _Global_Normal_Map, i.texcoord_0 ) ,_Global_Normalmap_Power ) );
			float3 temp_output_4100_0 = BlendNormals( lerpResult6503 , normalizeResult3901 );
			o.Normal = temp_output_4100_0;
			float2 appendResult7710 = float2( 1 , _Global_Color_Map_Far_Power );
			...
			float4 layeredBlend6512 = ( lerp( lerp( lerp( lerp( float4( 1,1,1,0 ) , Texture_1_Final950 , layeredBlendVar6512.x ) , Texture_2_Final3385 , layeredBlendVar6512.y ) , Texture_3_Final3451 , layeredBlendVar6512.z ) , Texture_4_Final3518 , layeredBlendVar6512.w ) );
			...
			fixed4 tex2DNode7708 = tex2D( _Global_Color_Map, i.texcoord_0 );
			...
			float3 appendResult1410 = float3( ( _Texture_Snow_Average * _Snow_Color ).x , ( _Texture_Snow_Average * _Snow_Color ).y , ( _Texture_Snow_Average * _Snow_Color ).z );
