    ...
    public class CTSProfileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showGlobalSettings == true)
            {
                ...
                globalNormalPower = EditorGUILayout.Slider(GetLabel("Global Normal Power"), globalNormalPower, 0f, 1f); //0.5
                ...
                globalAOType = (CTSConstants.AOType)EditorGUILayout.EnumPopup(GetLabel("Occlusion Type"), globalAOType);
                ...
                if (globalAOType != CTSConstants.AOType.None)
                {
                    ...
                    if (shaderType == CTSConstants.ShaderType.Basic && globalAOType == CTSConstants.AOType.TextureBased)
                    {
            ...
            if (showTextureSettings == true)
            {
                ...
                for (int idx = 0; idx < textureSettings.Count; idx++)
                {
                    ...
                    if (td.m_isOpenInEditor)
                    {
                        ...
                        td.Albedo = (Texture2D)EditorGUILayout.ObjectField("Albedo", td.Albedo, typeof(Texture2D), false, GUILayout.Height(16f));
                        ...
                        if (td.Albedo != null)
                        {
                            td.Normal = (Texture2D)EditorGUILayout.ObjectField("Normal", td.Normal, typeof(Texture2D), false, GUILayout.Height(16f));
                            ...
                            td.Smoothness = (Texture2D)EditorGUILayout.ObjectField("Smoothness", td.Smoothness, typeof(Texture2D), false, GUILayout.Height(16f));
                            ...
                            td.Roughness = (Texture2D)EditorGUILayout.ObjectField("Roughness", td.Roughness, typeof(Texture2D), false, GUILayout.Height(16f));
                            DrawHelpLabel("Roughness Tx");
                            ...
                            {
                                td.Height = (Texture2D)EditorGUILayout.ObjectField("Height", td.Height, typeof(Texture2D), false, GUILayout.Height(16f));
                                ...
                                {
                                    td.AmbientOcclusion = (Texture2D)EditorGUILayout.ObjectField("Occlusion", td.AmbientOcclusion, typeof(Texture2D), false, GUILayout.Height(16f));
                        ...
                        td.m_tint = EditorGUILayout.ColorField(GetLabel("Tint"), td.m_tint, true, false, false, null);
                        DrawHelpLabel("Tint");
            ...
            if (colorMapClosePower == 0f && colorMapFarPower == 0f)
            {
            ...
            Texture2D snowNoise = m_profile.SnowNoise;
            ...
            if (showSnowSettings == true)
            {
                ...
                snowNoise = (Texture2D)EditorGUILayout.ObjectField("Noise", snowNoise, typeof(Texture2D), false, GUILayout.Height(16f));
                DrawHelpLabel("Noise");
                ...
                if (snowAlbedo != null)
                {
                    ...
                    {
                        rect.position = new Vector2(rect.position.x + 57f, rect.position.y);
                        EditorGUI.DrawPreviewTexture(rect, snowNoise);
                        DrawImageLabel(rect, "N");
                    }
                    ...
                    snowTint = EditorGUILayout.ColorField(GetLabel("Tint"), snowTint, true, false, false, null);
                    DrawHelpLabel("Tint");
            ...
            bool globalOptimiseAtRuntime = m_profile.m_globalOptimiseAtRuntime;
            float globalBasemapDistance = m_profile.m_globalBasemapDistance;
            bool persistMaterials = m_profile.m_persistMaterials;
            bool globalDisconnectAtRuntime = m_profile.m_globalDisconnectAtRuntime;
            ...
            if (showOptimisationSettings)
            {
                ...
                globalOptimiseAtRuntime = EditorGUILayout.Toggle(GetLabel("Strip Textures"), globalOptimiseAtRuntime);
                DrawHelpLabel("Strip Textures");

                globalDisconnectAtRuntime = EditorGUILayout.Toggle(GetLabel("Disconnect Profile"), globalDisconnectAtRuntime);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                m_profile.m_globalOptimiseAtRuntime = globalOptimiseAtRuntime;
                m_profile.m_globalDisconnectAtRuntime = globalDisconnectAtRuntime;
        ...
        static Dictionary<string, string> m_tooltips = new Dictionary<string, string>
        {
            ...
            { "ColorMap Settings", "    This sections controls how the color map is applied to the terrain. A color map is a texture that is blended with the terrain to add more visual interest to it."},
            ...
            { "Shader Type", "The type of shader used to render the terrain.\n<b>Unity</b> - The Unity terrain shader.\n<b>Basic</b> - The CTS basic terrain shader - good and fast.\n<b>Advanced</b> - The CTS Advanced terrain shader. Very fast, and adds in height blending.\n<b>Tesselation</b> - The CTS Advanced Tesselation terrain shader is not quite as fast, but adds in tesselation."},
            { "Roughness Tx", "Optional texture that defines roughness. Infuences reflections - smooth surfaces reflect light back like a mirror and rough surfaces scatter light at many angles. Will be baked into Alpha channel of Albedo."},
            { "Smoothness Tx", "Optional texture that defines smoothness. Infuences reflections - smooth surfaces reflect light back like a mirror and rough surfaces scatter light at many angles. Will be baked into Alpha channel of Albedo."},
            { "Smoothness", "The global terrain or per texture smoothness. Infuences reflections - smooth surfaces reflect light back like a mirror and matte surfaces scatter light at many angles."},
