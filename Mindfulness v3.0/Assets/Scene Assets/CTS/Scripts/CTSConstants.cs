namespace CTS
{
    ...
    public static class CTSConstants
    {
        ...
        /// </summary>
        public enum ShaderType { Unity, Basic, Advanced, Tesselation }

        /// <summary>
        /// Names of the various shaders
        /// </summary>
        public const string CTSShaderName = "CTS Terrain";
        public const string CTSShaderBasicName = "CTS Terrain Shader Basic";
        public const string CTSShaderBasicCutoutName = "CTS Terrain Shader Basic CutOut";
        public const string CTSShaderAdvancedName = "CTS Terrain Shader Advanced";
        public const string CTSShaderAdvancedCutoutName = "CTS Terrain Shader Advanced CutOut";
        public const string CTSShaderTesselatedName = "CTS Terrain Shader Advanced Tess";
        public const string CTSShaderTesselatedCutoutName = "CTS Terrain Shader Advanced Tess CutOut";
